...
export default function BusinessDetailsScreen() {
  ...
  const onMessageBtnClick=()=>{
    Linking.openURL('mailto:'+business?.email+"?subject=Service Inquiry for Find-A-Fix At Home Services&body=Hello There,%0D%0A%0D%0A Welcome to Find-A-Fix!%0D%0A%0D%0AKindly leave your message below:");
  }
  ...
  return business&&(
    ...
    <ScrollView style={{height:'90%'}}>
      ...
      <View style={styles.infoContainer}>
        ...
        <Text style={{fontSize:17,fontFamily:'outfit',color:Colors.RED}}>
        ...
        <View style={{borderWidth:1,borderColor:Colors.RED,marginTop:10,
        ...
        <View style={{borderWidth:1,borderColor:Colors.RED,marginTop:20,
            marginBottom:20}}></View>

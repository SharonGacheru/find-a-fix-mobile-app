...
export default function ProfileScreen() {
  ...
  return (
    <View >
      ...
      <PageHeading title={'My Profile'} color={Colors.WHITE} />
        {/*<Text style={{fontSize:20,fontFamily:'outfit-bold',color:Colors.WHITE}}>ProfileScreen</Text>*/}
        <View style={{
          display:'flex',
          ...
          <Text style={{fontSize:16,marginTop:8,fontFamily:'outfit-medium',
